...
+ 胜利条件
    ...
    + 邪恶
        1. 圣徒被投票处决，且未中毒
        2. 活人数小于等于4，平民可投的票数不大于活人的半数（向上取整），且存活的邪恶玩家数量不小于活人的半数（向上取整），且没有杀手或有杀手没有子弹，且没有市长或市长已死或酒鬼市长
        3. 平民阵营被屠城
+ 与无辅助器的不同之处
    + 没有说书人
    + 全程不需闭眼
...
| 被动 `\\` 主动 | 下毒者 | 僧侣  | 魅魔  | 小恶魔 | 守鸦人 | 共情者 | 占卜师 | 管家  | 掘墓人 | 杀手  | 圣女  |
|:----------:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
|    下毒者     |  ❎  |  ✅  |  ❎  |  ✅  |  ✅  |  ❎  |  ✅  |  ✅  |  ✅  |  ✅  |  ✅  |
|     僧侣     |  ✅  |  ❎  |  ❎  |  ✅  |  ✅  |  ❎  |  ✅  |  ✅  |  ✅  |  ✅  |  ✅  |
|     魅魔     |     |  ✅  |  ❎  |  ✅  |  ✅  |  ❎  |  ✅  |  ✅  |  ✅  |  ✅  |  ✅  |
...
+ 总日志所有人名后面带身份
+ ipad灰屏bug
+ bug：复盘中时，退出游戏，再进入复盘中的房间，其实此人并不在房间中，需要退出再进来
+ 游戏结束音效
+ bug：市长局，晚上刀一个，白天投一个，结算不应该结束游戏，待回测
+ bug：邪恶胜利条件3，屠城，剩最后2人，不应该直接结束游戏，无法复现
